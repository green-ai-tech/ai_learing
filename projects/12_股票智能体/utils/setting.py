...
# ===================== 【自动获取项目根路径】 =====================
# 获取当前文件（setting.py）的绝对路径
CURRENT_FILE_PATH = os.path.abspath(__file__)

# 项目根目录 = 当前文件的 上两级目录
# 结构：projects/12股票智能体/utils/setting.py
# 所以根目录 = 12股票智能体
...
class Settings(BaseSettings):
    ...
    #====================2. RAG与向量数据库的配置===================
    vector_store_dir: str         = Field(default=os.path.join(PROJECT_ROOT, "data"),  description="向量数据库目录")
    ...
    log_file: str                   = Field(default=os.path.join(PROJECT_ROOT, "logs/stock_agent.log"), description="日志文件路径")
